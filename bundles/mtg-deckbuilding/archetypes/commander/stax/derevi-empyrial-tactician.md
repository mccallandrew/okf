...
type: Example Deck
title: "Derevi Stax"
description: Resource-denial stax under Derevi with a lean win path.
tags: [mtg, deckbuilding, commander, example-deck, stax]
status: draft
...
Be warned that Stax decks are typically frowned upon at casual tables. People don’t really sit down to play Magic in the hopes of _not_ playing Magic, so you should probably save your Stax deck for a table of players you know well or for a more competitive setting.[^draftsim-edh-arch]
...
* [Stax](/archetypes/commander/stax/overview.md)
