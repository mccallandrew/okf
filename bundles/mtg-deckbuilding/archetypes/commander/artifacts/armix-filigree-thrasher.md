---
type: Example Deck
title: "Armix Affinity / Artifacts"
description: Artifact-matters list with cost reduction and artifact payoffs.
tags: [mtg, deckbuilding, commander, example-deck, artifacts]
status: draft
...
The decklist here has most of the elements you can expect from an artifact deck, regardless of color identity. It has sac outlets, tutors, ramp spells, and wincons, all of which are tailored specifically towards artifacts.[^draftsim-edh-arch]
...
* [Affinity/Artifacts](/archetypes/commander/artifacts/overview.md)
